...
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <li><a href="" class="active">ทำเนียบอดีตอาจารย์</a></li>
    ...
    <div class="container">
        <div class="search-path">
            <div class="title">ค้นหาข้อมูลอดีตอาจารย์</div>
            <form action="">
                <div class="form-row">
                    <div class="col-auto">
                ...
                <div class="form-row">
                    <div class="col-auto">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <div class="input-group-text">วิชาที่สอน</div>
                            </div>
                            <input type="text" class="form-control">
                        </div>
                    </div>
                </div>
                <p>** ท่านสามารถสืบค้นได้จาก รหัสนักเรียน ชื่อ นามสกุล วิชาที่สอน
        ...
        <div class="table-responsive-md">
            <h3>รายชื่ออดีตอาจารย์ จำนวน .... รายการ</h3>
            <table id="example" class="table" style="width: 100%">
                <thead>
                    <tr class="table-primary">
                        <th width="10%">ลำดับ</th>
                        <th width="40%">ชื่อ-นามสกุล</th>
                        <th width="30%">วิชาที่สอน</th>
                        <th width="20%"></th>
                    </tr>
                </thead>
                <tbody>
                            ...
                            <div class="p-body">
                                <div class="form-row">
                                    ...
                                    <div class="col-auto">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">เบอร์โทร 1</div>
                                            </div>
                                            <input type="text" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">เบอร์โทร 2</div>
                                            </div>
                                            <input type="text" class="form-control" readonly>
                                        </div>
                                    </div>
